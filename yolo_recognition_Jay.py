...
class Object_detect():
    ...
    def move(self, x, y, color):
        ...
        self.mc.send_coords([x, y, 65, 190, -3.78, -62.75], 40, 1)
        ...
        self.mc.send_coords(self.move_coords[inp_bin], 40, 1)
        time.sleep(4)
        ...
        if input == ord('q'):
            ...
            for _ in range(2): 
                ...
                if roi != (0, 0, 0, 0):
                    ...
                    detect_result = detect.post_process(crop)

                    if detect_result:
                        cx, cy, input_img = detect_result
                        ...
                        detected_objects.append((real_x, real_y, detect.color))
            
            for obj in detected_objects:
                x, y, color = obj
                a = threading.Thread(target=lambda: detect.decide_move(x, y, color))
                a.start()
